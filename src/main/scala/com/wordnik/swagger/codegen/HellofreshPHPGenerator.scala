...
object HellofreshPHPGenerator extends HellofreshPHPGenerator {
  def main(args: Array[String]) = generateClient(args)
}

class HellofreshPHPGenerator extends BasicPHPGenerator {
  ...
  override def templateDir = "hellofreshphp"

  // where to write generated code
  override def destinationDir = "generated-code/hellofreshphp"
