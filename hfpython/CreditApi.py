...
class CreditApi(object):
    ...
    def claimCredit(self, **kwargs):
        r"""Claim credit

        Args:
            
            id, int: ID of the CreditEntry entity (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method claimCredit" % key)
            params[key] = val
        del params['kwargs']

        resourcePath = '/credit/{id}/claim'
