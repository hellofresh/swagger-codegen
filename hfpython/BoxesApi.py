    ...
    def getBox(self, **kwargs):
        ...
        for key, val in params['kwargs'].items():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method getBox" % key)
            params[key] = val
        del params['kwargs']

        resourcePath = '/boxes/{id}'
        ...
        responseObject = self.apiClient.deserialize(response, r'ApiModel\Box\Box')
